...
<context>
    ...
    <message>
        <source> Your current panel settings have been backed up in a hidden folder called .restore in your home folder (~/.restore/)</source>
        <translation type="vanished">Сіздің ағымдағы панель баптауларыңыз сіздің үй бумаңыздағы .restore деп аталатын жасырын бумаға (~/.restore/) қор көшірмеге сақталды</translation>
    </message>
    <message>
